...
describe Dessert do
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ['eggs', 'butter', 'milk', 'love']
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      cake.eat(3)
      expect(chef).to receive(:titleize).and_return('Chef Chris the Great Baker')
      expect(cake.serve).to eq('Chef Chris the Great Baker has made 2 cakes!')
    end
  end
