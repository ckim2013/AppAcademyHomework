...
function GiphysIndex(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    null,
    giphys.map(function (gif, idx) {
      return _react2.default.createElement(_giphys_index_item2.default, { key: idx, gif: gif });
    })
  );
}
...
var GiphysSearch = function (_React$Component) {
  ...
  function GiphysSearch(props) {
    ...
    _this.fetchSearchGiphys = props.fetchSearchGiphys;
...
var GiphysReducer = function GiphysReducer() {
  ...
  switch (action.type) {
    ...
    case _giphy_actions.REQUEST_SEARCH_GIPHYS:
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(59), __webpack_require__(217)(module)))
